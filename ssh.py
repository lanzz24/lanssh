...
class SSH:
	...
	def Chek(self):
		...
		if cek_2.find("div", class_="progress-bar progress-bar-danger") is not None:
			exit("  \x1b[1;97m[\x1b[1;91m#\x1b[1;97m] AKUN NYA GA TERSEDIA NGENTD\n SILAHKAN PILIH PASANGAN LAIN:V\n")
			time.sleep(2)
			system('python '+sys.argv[0])
...
def Menu():
   ...
   \x1b[1;93m ╔═╗╦═╗╔═╗╔═╗╔╦╗╔═╗  ╔═╗╔═╗╦ ╦
    ║  ╠╦╝║╣ ╠═╣ ║ ║╣   ╚═╗╚═╗╠═╣
    ╚═╝╩╚═╚═╝╩ ╩ ╩ ╚═╝  ╚═╝╚═╝╩ ╩
\x1b[1;97m     https://github.com/lanzz24
\x1b[1;91m+-----------------------------------+
...
\x1b[1;91m+-----------------------------------+""")
	...
	if pilih in ("1","01"):
		...
		exit("\x1b[1;91m+-----------------------------------+\n \x1b[1;97mTERIMAKASIH SUDAH MEMAKAI TOOLS LANZZ\n")
	else:
